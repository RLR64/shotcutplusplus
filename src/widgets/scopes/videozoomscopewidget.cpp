...
VideoZoomScopeWidget::VideoZoomScopeWidget()
    : ScopeWidget("VideoZoom"), m_zoomWidget(new VideoZoomWidget()), m_zoomLabel(new QLabel(this)),
      m_pixelXLabel(new QLabel(this)), m_pixelYLabel(new QLabel(this)), m_rLabel(new QLabel(this)),
      m_gLabel(new QLabel(this)), m_bLabel(new QLabel(this)), m_yLabel(new QLabel(this)), m_uLabel(new QLabel(this)),
...
void VideoZoomScopeWidget::onScreenSelectStarted() {
	...
	selectionSize.setWidth(
	    ...
	    (((double)m_zoomWidget->width() / (double)m_zoomWidget->getZoom()) / (double)MLT.profile().width()));
	selectionSize.setHeight(
	    (double)boundingRect.height() *
	    (((double)m_zoomWidget->height() / (double)m_zoomWidget->getZoom()) / (double)MLT.profile().height()));
