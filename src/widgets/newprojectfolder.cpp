...
void NewProjectFolder::showEvent(QShowEvent*) {
	...
	MAIN.buildVideoModeMenu(&m_videoModeMenu, m_customProfileMenu, m_profileGroup, ui->actionAddCustomProfile,
...
void NewProjectFolder::on_startButton_clicked() {
	...
	if (projectName.contains('?')) {
		QMessageBox::warning(this, ui->newProjectLabel->text(), tr("The project name cannot include '?'."));
		ui->startButton->setDisabled(true);
		return;
	}
