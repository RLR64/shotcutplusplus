...
MeltJob::MeltJob(const QString& name, const QString& xml, int frameRateNum, int frameRateDen,
    ...
    : AbstractJob(name, priority), m_isStreaming(false), m_previousPercent(0), m_currentFrame(0),
...
MeltJob::MeltJob(const QString& name, const QString& xml, const QStringList& args, int frameRateNum, int frameRateDen)
