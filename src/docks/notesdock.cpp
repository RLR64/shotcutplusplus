...
class TextEditor : public QPlainTextEdit {
  ...
  public:
	explicit TextEditor(QWidget*  /*parent*/ = nullptr) : QPlainTextEdit() {
		...
		connect(action, &QAction::triggered, this, [this]() -> void { setZoom(-4); });
		...
		connect(action, &QAction::triggered, this, [this]() -> void {
			...
			KokorodokiJob::prepareAndRun(this, [this]() -> void {
		...
		connect(this, &QWidget::customContextMenuRequested, this, [this](const QPoint& pos) -> void {
...
NotesDock::NotesDock(QWidget* parent)
    : QDockWidget(tr("Notes"), parent), m_textEdit(new TextEditor(this)), m_blockUpdate(false) {
	LOG_DEBUG() << "begin";
	setObjectName("NotesDock");
	QIcon const icon = QIcon::fromTheme("document-edit", QIcon(":/icons/oxygen/32x32/actions/document-edit.png"));
...
auto NotesDock::getText() -> QString {
