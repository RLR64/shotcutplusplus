...
static const char* SOUND_SAMPLE_DESCRIPTIONS[12] = {TAG_NONE, TAG_RAW_, TAG_TWOS, TAG_SOWT, TAG_FL32, TAG_FL64,
                                                    TAG_IN24, TAG_IN32, TAG_ULAW, TAG_ALAW, TAG_LPCM, TAG_MP4A};

static const char* CONTAINERS_LIST[20] = {TAG_MDIA, TAG_MINF, TAG_MOOV, TAG_STBL, TAG_STSD, TAG_TRAK,
                                          TAG_UDTA, TAG_WAVE,

                                          TAG_NONE, TAG_RAW_, TAG_TWOS, TAG_SOWT, TAG_FL32, TAG_FL64,
                                          TAG_IN24, TAG_IN32, TAG_ULAW, TAG_ALAW, TAG_LPCM, TAG_MP4A};

enum Type { Box = 0, Container, ContainerLeaf, None };
