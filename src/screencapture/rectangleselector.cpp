...
void RectangleSelector::paintEvent(QPaintEvent* event) {
	...
	if (m_selecting) {
		...
		painter.drawRect(selection.topLeft().x() - handleSize / 2, selection.topLeft().y() - handleSize / 2, handleSize,
		                 handleSize);
		painter.drawRect(selection.topRight().x() - handleSize / 2, selection.topRight().y() - handleSize / 2,
		                 handleSize, handleSize);
		painter.drawRect(selection.bottomLeft().x() - handleSize / 2, selection.bottomLeft().y() - handleSize / 2,
		                 handleSize, handleSize);
		painter.drawRect(selection.bottomRight().x() - handleSize / 2, selection.bottomRight().y() - handleSize / 2,
		                 handleSize, handleSize);
