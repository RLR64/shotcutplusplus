...
#define ROLLINGFILEAPPENDER_HPP
...
/*!
 * \brief The RollingFileAppender class extends FileAppender so that the underlying file is rolled over at a user chosen
 * frequency.
 *
 ...
 *
 * For example, if the fileName is set to /foo/bar and the DatePattern set to the daily rollover ('.'yyyy-MM-dd'.log'),
 * on 2014-02-16 at midnight, the logging file /foo/bar.log will be copied to /foo/bar.2014-02-16.log and logging for
 * 2014-02-17 will continue in /foo/bar until it rolls over the next day.
 *
