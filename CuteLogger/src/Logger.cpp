...
static void qtLoggerMessageHandler(QtMsgType type, const QMessageLogContext& context, const QString& msg) {
	...
	const bool isDefaultCategory = QString::fromLatin1(context.category) == "default";
...
/**
 * If set to true, all log messages to the specified category appenders will also be written to the global logger
 * instance appenders, registered using registerAppender().
 *
